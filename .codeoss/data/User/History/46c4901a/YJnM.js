document.addEventListener("DOMContentLoaded", () => {
    ...
    const initializeProfilePage = async () => {
        // Desabilita o botão enquanto os dados são carregados para evitar cliques prematuros.
        ...
        try {
            ...
            if (response.status === 404) {
                ...
                submitBtn.disabled = false; // Habilita o botão para cadastro.
                return;
            }
            ...
            if (profile.role !== "professional") {
                submitBtn.textContent = "Acesso Negado";
            ...
            // Se os horários já foram definidos, eles são carregados. Caso contrário, os campos ficam vazios.
            // Como os campos são 'required' no HTML, o profissional será obrigado a preenchê-los.
            ...
            // Habilita o botão e define o texto correto após o carregamento dos dados.
            submitBtn.textContent = "Salvar Alterações";
            submitBtn.disabled = false;

        } catch (error) {
            submitBtn.textContent = "Erro ao Carregar";
            submitBtn.disabled = false; // Habilita o botão para permitir nova tentativa
