  ...
  router.get("/", authenticate, async (req, res) => {
    try {
      ...
      const populatedAppointments = appointmentsData.map((app) => {
        ...
        // Remove o prontuário para não expor na listagem geral
        const {medicalRecord, recordUpdatedAt, ...restOfApp} = app;
        ...
        return {
          ...
          hasMedicalRecord: !!medicalRecord, // Adiciona um indicador se o prontuário existe
        };
      });
