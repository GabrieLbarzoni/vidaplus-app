...
// em public/profile.js
data = {
    // ...
    specialty: especialidadeInput.value, // Enviando como 'specialty'
    // ...
};
// em functions/routes/professionals.js (CÓDIGO ATUAL COM ERRO)
const {name, celular, especialidade, horarioInicio, horarioFim} = req.body;
// ...
const updatedData = {
    // ...
    specialty: especialidade, // Aqui, 'especialidade' é undefined
    // ...
};
