...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Garante que este script só execute na página da dashboard (index.html).
    // Se o elemento #app não existir, o script para aqui para evitar erros em outras páginas.
    if (!appContainer) {
        return;
    }
